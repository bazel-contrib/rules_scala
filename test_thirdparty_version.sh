...
# $runner test_scala_version "3.10.0" # Latest Next version
$runner test_scala_version "3.9.0" # Latest LTS 3.9 version
$runner test_scala_version "3.3.8" # Latest LTS 3.3 version
